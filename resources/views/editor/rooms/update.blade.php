...
@section('content')
    ...
    <section class="content">
        ...
        @endif
        <form method="post" action="{{ url($user->id. '/editor/rooms/update/'. $room->id) }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <a class="btn btn-secondary" href="{{ url($user->id. '/editor/rooms/index') }}">
                    Quay lại
                </a>
            </div>
        </form>
