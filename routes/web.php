...
|
*/
Route::group(['prefix' => '{userID}', 'middleware' => 'checkEditor'], function () {
    Route::group(['prefix' => 'editor'], function () {
        Route::group(['prefix' => 'rooms'], function () {
            Route::get('index', 'App\Http\Controllers\Editor\RoomEditorController@getIndex');
            Route::get('create', 'App\Http\Controllers\Editor\RoomEditorController@getCreate');
            Route::post('create', 'App\Http\Controllers\Editor\RoomEditorController@postCreate');
            Route::get('update/{id}', 'App\Http\Controllers\Editor\RoomEditorController@getUpdate');
            Route::post('update/{id}', 'App\Http\Controllers\Editor\RoomEditorController@postUpdate');
            Route::get('delete/{id}', 'App\Http\Controllers\Editor\RoomEditorController@delete');
        });
        Route::group(['prefix' => 'posts'], function () {
            Route::get('index', 'App\Http\Controllers\Editor\PostEditorController@getIndex');
            Route::get('create', 'App\Http\Controllers\Editor\PostEditorController@getCreate');
            Route::post('create', 'App\Http\Controllers\Editor\PostEditorController@postCreate');
            Route::get('update/{id}', 'App\Http\Controllers\Editor\PostEditorController@getUpdate');
            Route::post('update/{id}', 'App\Http\Controllers\Editor\PostEditorController@postUpdate');
            Route::get('delete/{id}', 'App\Http\Controllers\Editor\PostEditorController@delete');
        });
    });
});
...
Route::get('mail','App\Http\Controllers\MailController@index')->middleware('checkLogin');
//endFrontend
